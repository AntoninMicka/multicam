...
<template>
  <section class="interface-panel">
    <div class="heading"><div><span class="eyebrow">přístup ke klientovi</span><h3>QR frontendu podle rozhraní</h3></div><button class="small" @click="refresh">Obnovit</button></div>
